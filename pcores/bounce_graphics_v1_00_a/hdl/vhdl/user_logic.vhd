...
-- Date:              Sat Jun 04 23:57:02 2016 (by Create and Import Peripheral Wizard)
...
begin
  ...
  --USER logic implementation added here
	ResetxRB <= not Bus2IP_Reset;
	 ...
	 GRAPHICS: entity bounce_graphics_v1_00_a.graphics_controller(rtl)
    port map(
      ClkxCI         => Bus2IP_Clk,
      RstxRBI        => ResetxRB,
		
		ScorexDI 		=> slv_reg0(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		HighScorexDI	=> slv_reg1(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		XPlatexDI      => slv_reg2(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YPlatexDI      => slv_reg3(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		XSubplatexDI   => slv_reg4(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YSubplatexDI   => slv_reg5(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		
      XBall1xDI       => slv_reg6(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
      YBall1xDI       => slv_reg7(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		XBall2xDI       => slv_reg8(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
      YBall2xDI       => slv_reg9(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		XBall3xDI       => slv_reg10(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
      YBall3xDI       => slv_reg11(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		XBall4xDI       => slv_reg12(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
      YBall4xDI       => slv_reg13(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YBoost1xDI       => slv_reg14(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YBoost2xDI       => slv_reg15(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YBlock1xDI       => slv_reg16(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
		YBlock2xDI       => slv_reg17(C_SLV_DWIDTH-10 to C_SLV_DWIDTH-1),
  ...
  slv_write_ack     <= Bus2IP_WrCE(0) or Bus2IP_WrCE(1) or Bus2IP_WrCE(2) or Bus2IP_WrCE(3) or Bus2IP_WrCE(4) or Bus2IP_WrCE(5) or Bus2IP_WrCE(6) or Bus2IP_WrCE(7) or Bus2IP_WrCE(8) or Bus2IP_WrCE(9) or Bus2IP_WrCE(10) or Bus2IP_WrCE(11) or Bus2IP_WrCE(12) or Bus2IP_WrCE(13) or Bus2IP_WrCE(14) or Bus2IP_WrCE(15) or Bus2IP_WrCE(16) or Bus2IP_WrCE(17);
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(1) or Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4) or Bus2IP_RdCE(5) or Bus2IP_RdCE(6) or Bus2IP_RdCE(7) or Bus2IP_RdCE(8) or Bus2IP_RdCE(9) or Bus2IP_RdCE(10) or Bus2IP_RdCE(11) or Bus2IP_RdCE(12) or Bus2IP_RdCE(13) or Bus2IP_RdCE(14) or Bus2IP_RdCE(15) or Bus2IP_RdCE(16) or Bus2IP_RdCE(17);
  ...
  SLAVE_REG_READ_PROC : process( slv_reg_read_sel, slv_reg0, slv_reg1, slv_reg2, slv_reg3, slv_reg4, slv_reg5, slv_reg6, slv_reg7, slv_reg8, slv_reg9, slv_reg10, slv_reg11, slv_reg12, slv_reg13, slv_reg14, slv_reg15, slv_reg16, slv_reg17 ) is
  begin

    case slv_reg_read_sel is
      when "100000000000000000" => slv_ip2bus_data <= slv_reg0;
      when "010000000000000000" => slv_ip2bus_data <= slv_reg1;
      when "001000000000000000" => slv_ip2bus_data <= slv_reg2;
      when "000100000000000000" => slv_ip2bus_data <= slv_reg3;
      when "000010000000000000" => slv_ip2bus_data <= slv_reg4;
      when "000001000000000000" => slv_ip2bus_data <= slv_reg5;
      when "000000100000000000" => slv_ip2bus_data <= slv_reg6;
      when "000000010000000000" => slv_ip2bus_data <= slv_reg7;
      when "000000001000000000" => slv_ip2bus_data <= slv_reg8;
      when "000000000100000000" => slv_ip2bus_data <= slv_reg9;
      when "000000000010000000" => slv_ip2bus_data <= slv_reg10;
      when "000000000001000000" => slv_ip2bus_data <= slv_reg11;
      when "000000000000100000" => slv_ip2bus_data <= slv_reg12;
      when "000000000000010000" => slv_ip2bus_data <= slv_reg13;
      when "000000000000001000" => slv_ip2bus_data <= slv_reg14;
      when "000000000000000100" => slv_ip2bus_data <= slv_reg15;
      when "000000000000000010" => slv_ip2bus_data <= slv_reg16;
      when "000000000000000001" => slv_ip2bus_data <= slv_reg17;
